...
Sub ResumeExt(IDs)
  ...
  postData = "apikey=" + apiKey + "&validation=token&authToken=" + token + "&timestamp=" + FmtDate(dtGMT) + "&action=activateExternalMonitor&monitorIds=" + IDs
  wscript.echo "Activate monitors " + IDs
