...
function LogBtn_Click
{
	...
	$url = "http://www.monitis.com/api?action=apikey&userName="+$LoginTxt.Text+"&password="+$pass+"&output=xml&version=2"
	...
	$url = "http://www.monitis.com/api?action=secretkey&apikey="+$apikey+"&output=xml&version=2"
