...
function startbtn_click
{
	if($rdBtn_Daily.checked -eq $true)
	{
		...
		$starttime = $dateTimePicker_startTime.Value.ToString("HH:mm:ss")
		$duration = $DurationdateTimePicker.Value.ToString("HH:mm")
		$startdate = $dateTimePicker_startDate.Value.Date.ToString("MM/dd/yyyy")
		$enddate = $dateTimePicker_expire.Value.Date.ToString("MM/dd/yyyy")
		...
		if($startdate -lt [System.DateTime]::Now.ToString("MM/dd/yyyy"))
		{
	...
	if($rdBtn_Weekly.Checked -eq $true)
	{
		...
		#compare start date and now date
		#start date cannot be earlier than now date
		elseif($startdate -lt [System.DateTime]::Now.ToString("MM/dd/yyyy"))
		{
			[System.Windows.Forms.MessageBox]::Show("The date a task begins cannot be earlier than the current date")
		}
		#compare start date and end date
	...
	{			
		...
		elseif((($starttime -lt [System.DateTime]::Now.ToString("HH:mm:ss")) -and  ($startdate -le [System.DateTime]::Now.ToString("MM/dd/yyyy"))) -or (($starttime -gt [System.DateTime]::Now.ToString("HH:mm:ss")) -and  ($startdate -lt [System.DateTime]::Now.ToString("MM/dd/yyyy"))))
		{
...
$dateTimePicker_expire.Value = [System.DateTime]::Now;
	
#$Duration Time
$DurationdateTimePicker.Format = [System.Windows.Forms.DateTimePickerFormat]::Custom
$DurationdateTimePicker.Location = New-Object System.Drawing.Point(300, 200);
...
#start date
$dateTimePicker_startDate.Format = [System.Windows.Forms.DateTimePickerFormat]::Custom;
...
$dateTimePicker_startDate.Value = [System.DateTime]::Now;
...
# textBox repeat 
$txtBx_repeat.Location = New-Object System.Drawing.Point(106, 200);
...
$lbl_days.Location = New-Object System.Drawing.Point(147, 101);
$lbl_days.Size = New-Object System.Drawing.Size(29, 13);
$lbl_days.Text = "days";

#textbox recur
$txtBx_recur.Location = New-Object System.Drawing.Point(101, 98);
