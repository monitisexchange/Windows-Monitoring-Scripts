...
{
	if($al.SelectSingleNode("monitorID").Innertext -eq "0")
	{
...
$Form.ClientSize = New-Object System.Drawing.Size(370, 380)
...
$btn_Next.Location = New-Object System.Drawing.Point(291, 350);
...
$btn_Test.Location = New-Object System.Drawing.Point(5, 350);
...
$btn_back.Location = New-Object System.Drawing.Point(213, 350);
...
$AppTab.Size = New-Object System.Drawing.Size(370, 345);
